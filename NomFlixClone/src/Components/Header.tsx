...
const Logo = styled(motion.svg)`
    ...
    width: 95px;
    height: 25px;
    color: ${(props) => {return props.theme.white.darker}};
    transition: color 0.3s ease-in-out;
    fill: ${(props) => {return props.theme.red}};
    path {
        stroke-width: 6px;
        stroke:white;
    }
...
const Items = styled.ul`
    display:flex;
    align-items: center;
    color:${(props) => {return props.theme.white.lighter}};
`;
...
//무언가 중앙에 두고싶으면 position: absolute, margin: 0 auto, left: 0, right: 0
...
function Header() {
    ...
    const toggleSearch = () => {
        if (searchOpen) {
            ...
            // 특정 코드를 통해서 animation을 실행하고 싶을 때
            // 에니메이션을 동시에 실행할 때
        ...
        animate={navAnimation}>
            ...
            <Col>
                ...
                <motion.svg
                    ...
                    animate={{x: searchOpen ? -150 : 0, scale:0.8}}
